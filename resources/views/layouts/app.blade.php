...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('profile.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('profile.png') }}">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
                <img src="{{ asset('profile.png') }}" alt="Tanveer Hassan" class="rounded-circle me-2" width="35" height="35" style="object-fit: cover; border: 2px solid var(--secondary-color);">
                Tanveer Hassan
            </a>
